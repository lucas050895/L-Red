                ...
                <?php
                    ...
                    while ($fila = $resultadoUsuario->fetch_assoc()) { ?>
                        ...
                        <section>
                            ...
                            <div>
                                <a href="https://lucasconde.ddns.net/L-Red/links/usuario/editar_usuario.php?id=<?php echo $fila['id'] ?> ">
                        ...
                        <section>
                            ...
                            <div>
                                <a href="https://lucasconde.ddns.net/L-Red/links/usuario/editar_password.php?id=<?php echo $fila['id'] ?> ">
                                    <i class="fa-solid fa-pen"></i>
                                </a>
                            </div>
                        </section>
